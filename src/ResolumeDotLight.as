/**
 * Copyright kumafu ( http://wonderfl.net/user/kumafu )
 * MIT License ( http://www.opensource.org/licenses/mit-license.php )
 * Downloaded from: http://wonderfl.net/c/rcBr
 */

// forked from ProjectNya's DotLight [Blue]
// forked from ProjectNya's DotLight
////////////////////////////////////////////////////////////////////////////////
// [AS3.0] ãƒ‰ãƒƒãƒˆã®å…‰ (6)
...
package {
	...
	public class ResolumeDotLight extends Sprite {
		private var light:DotLight;
		
		public function ResolumeDotLight() {
			init();
		}
		...
		private function init():void {
			...
			graphics.endFill();
			light = new DotLight(new Rectangle(0, 0, 640, 480));
			addChild(light);
			light.start();
		}
