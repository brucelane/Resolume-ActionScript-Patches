 ...
 * Downloaded from: http://wonderfl.net/c/jAUb
 */
...
package {
	...
	public class Kaleidoscope extends Sprite
	{
		...
		private var hx       :Number = 640 / 2;
		private var hy       :Number = 480 / 2;
		...
		private function handleEnterFrame(e:Event):void {            
			...
			var ra:Number = 2 * Math.PI * (hx - tx) / 640;
			var nv:Number = 0.5 - 0.4 * Math.min( 1, Math.abs(ty/480) );
