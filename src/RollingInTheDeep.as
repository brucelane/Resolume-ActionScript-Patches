 ...
 * Downloaded from: http://wonderfl.net/c/15wK
 */
...
package {
	...
	public class RollingInTheDeep extends Sprite {
		...
		private function init(e:Event = null):void {
			...
			fx = new VolumetricPointLight(640, 480, oldskool,[0x2c1400,0x020009,0x000400,0x000400]);
			fx.visible = false;
			addChild(fx);
			fx.startRendering();
...
final class OldSkool extends Sprite {
	...
	private function loadSound():void {
		...
		_mySound.load(new URLRequest("saturn.mp3"));
	}
