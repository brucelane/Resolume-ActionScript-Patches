 ...
 * Downloaded from: http://wonderfl.net/c/iJe3
 */
...
package {
	...
	public class MetaBalls3D extends Sprite {
		...
		private var skyBmd:BitmapData = new BitmapData(640, 232, false, 0);
		private var sea:Sea = new Sea(skyBmd);
		private var waves:Wave2;
		private var player:BeatPortPlayer;
		private var resolume:Resolume = new Resolume();
		private var leftSlider:FloatParameter = resolume.addFloatParameter("left", 0);
		private var leftSlider2:FloatParameter = resolume.addFloatParameter("left2", 0);
		private var rightSlider:FloatParameter = resolume.addFloatParameter("right", 0);
		private var rightSlider2:FloatParameter = resolume.addFloatParameter("right2", 0);
		private var multiplierSlider:FloatParameter = resolume.addFloatParameter("multiplier", 1);
		private var l1:Number = 0;
		private var l2:Number = 0;
...
class Sea extends Sprite {
	...
	private var output:BitmapData = new BitmapData(640, (480+1)/2, false);
	private var noise:BitmapData = new BitmapData(640/2, (480+3)/4, true);
	private var upsideDown:BitmapData = new BitmapData(640, (480+1)/2, true);
	private var gradient:BitmapData = new BitmapData(640, (480+1)/2, false);
	private var seaShape:Shape = new Shape;
	private var seaBmd:BitmapData = new BitmapData(640, (480+1)/2, true);
	...
	private const upsideDownMtx:Matrix = new Matrix(1, 0, 0, -1, 0, 480/2);
	...
	public function Sea(backdrop:BitmapData) {
		vertices.push(0, 0, 640-1, 0, 0, 480/2-1, 640-1, 480/2-1);
		uvt.push(
			0, 0, nearScale, 
			1, 0, nearScale, 
			(1-nearScale)/2, 1, 1,
	...
	private function initNoise():void {
		for(var i:int = 0; i < octaves; i++) {
			var bmd:BitmapData = new BitmapData(640/2, (480+3)/4, true, 0);
	...
	public function update():void {
		...
		upsideDown.draw(backdrop, new Matrix(1, 0, 0, -1, 0, 480/2), new ColorTransform(0.25,0.25,0.25));
